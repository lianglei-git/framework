...
export default function App() {
  ...
  if (!showTestPanel) {
    return (
      <div className="page-center">
        <h1 className="app-title">unitauthsdk_demo</h1>
        <p className="hint">unitauthsdk · FE :5179 · BFF :5560</p>
  ...
  return (
    <div className="app-root">
      <header className="app-header">
        <span className="app-title">unitauthsdk_demo</span>
        <span className="hint">FE :5179 · BFF :5560 · IdP :8080</span>
      </header>
