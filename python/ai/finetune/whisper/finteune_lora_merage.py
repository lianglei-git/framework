...
from uutils import print_arguments, add_arguments

parser = argparse.ArgumentParser(description=__doc__)
add_arg = functools.partial(add_arguments, argparser=parser)
add_arg("lora_model", type=str, default="/home/apple/Zayne/fine-turning-whisper-turbo/dev/output/whisper-large-v3-turbo-finetune/checkpoint-best", help="微调保存的模型路径")
